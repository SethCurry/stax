...
func (cfc *CardFaceCreate) check() error {
	if _, ok := cfc.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`oracledb: missing required field "CardFace.name"`)}
	}
	...
	if _, ok := cfc.mutation.FlavorText(); !ok {
		return &ValidationError{Name: "flavor_text", err: errors.New(`oracledb: missing required field "CardFace.flavor_text"`)}
	}
	...
	if _, ok := cfc.mutation.OracleText(); !ok {
		return &ValidationError{Name: "oracle_text", err: errors.New(`oracledb: missing required field "CardFace.oracle_text"`)}
	}
	...
	if _, ok := cfc.mutation.Language(); !ok {
		return &ValidationError{Name: "language", err: errors.New(`oracledb: missing required field "CardFace.language"`)}
	}
	if _, ok := cfc.mutation.Cmc(); !ok {
		return &ValidationError{Name: "cmc", err: errors.New(`oracledb: missing required field "CardFace.cmc"`)}
	}
	if _, ok := cfc.mutation.Power(); !ok {
		return &ValidationError{Name: "power", err: errors.New(`oracledb: missing required field "CardFace.power"`)}
	}
	if _, ok := cfc.mutation.Toughness(); !ok {
		return &ValidationError{Name: "toughness", err: errors.New(`oracledb: missing required field "CardFace.toughness"`)}
	}
	if _, ok := cfc.mutation.Loyalty(); !ok {
		return &ValidationError{Name: "loyalty", err: errors.New(`oracledb: missing required field "CardFace.loyalty"`)}
	}
	if _, ok := cfc.mutation.ManaCost(); !ok {
		return &ValidationError{Name: "mana_cost", err: errors.New(`oracledb: missing required field "CardFace.mana_cost"`)}
	}
	if _, ok := cfc.mutation.TypeLine(); !ok {
		return &ValidationError{Name: "type_line", err: errors.New(`oracledb: missing required field "CardFace.type_line"`)}
	}
	if _, ok := cfc.mutation.Colors(); !ok {
		return &ValidationError{Name: "colors", err: errors.New(`oracledb: missing required field "CardFace.colors"`)}
	}
	return nil
}
