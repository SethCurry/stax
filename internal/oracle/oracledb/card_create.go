...
func (cc *CardCreate) check() error {
	if _, ok := cc.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`oracledb: missing required field "Card.name"`)}
	}
	...
	if _, ok := cc.mutation.OracleID(); !ok {
		return &ValidationError{Name: "oracle_id", err: errors.New(`oracledb: missing required field "Card.oracle_id"`)}
	}
	...
	if _, ok := cc.mutation.ColorIdentity(); !ok {
		return &ValidationError{Name: "color_identity", err: errors.New(`oracledb: missing required field "Card.color_identity"`)}
	}
	return nil
}
