...
import (
	...
	"github.com/SethCurry/stax/internal/oracle/oracledb/migrate"
...
var ErrTxStarted = errors.New("oracledb: cannot start a transaction within a transaction")
...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("oracledb: starting a transaction: %w", err)
	}
	cfg := c.config
	cfg.driver = tx
	return &Tx{
...
func (c *Client) Mutate(ctx context.Context, m Mutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("oracledb: unknown mutation type %T", m)
	}
}
...
func (c *ArtistClient) mutate(ctx context.Context, m *ArtistMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("oracledb: unknown Artist mutation op: %q", m.Op())
	}
}
...
func (c *CardClient) mutate(ctx context.Context, m *CardMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("oracledb: unknown Card mutation op: %q", m.Op())
	}
}
...
func (c *CardFaceClient) mutate(ctx context.Context, m *CardFaceMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("oracledb: unknown CardFace mutation op: %q", m.Op())
	}
}
...
func (c *PrintingClient) mutate(ctx context.Context, m *PrintingMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("oracledb: unknown Printing mutation op: %q", m.Op())
	}
}
...
func (c *PrintingImageClient) mutate(ctx context.Context, m *PrintingImageMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("oracledb: unknown PrintingImage mutation op: %q", m.Op())
	}
}
...
func (c *RulingClient) mutate(ctx context.Context, m *RulingMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("oracledb: unknown Ruling mutation op: %q", m.Op())
	}
}
...
func (c *SetClient) mutate(ctx context.Context, m *SetMutation) (Value, error) {
	...
	default:
		return nil, fmt.Errorf("oracledb: unknown Set mutation op: %q", m.Op())
	}
}
