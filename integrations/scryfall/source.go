...
// SourceWOTC returns a Source representing Wizards of the Coast.
func SourceWOTC() Source {
	return Source("wotc")
}

// SourceScryfall returns a Source representing Scryfall.
func SourceScryfall() Source {
